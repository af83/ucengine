...
setup_users(Domain) ->
    uce_role:add(Domain, #uce_role{id={"default", Domain},
                                   acl=[#uce_access{action="add", object="presence"},
                                   #uce_access{action="delete", object="presence"}]}),

    uce_role:add(Domain, #uce_role{id={"root", Domain},
                                   acl=[#uce_access{action="all", object="all"}]}),

    uce_role:add(Domain, #uce_role{id={"participant", Domain},
                                   acl=[#uce_access{action="add", object="presence"},
                                        #uce_access{action="delete", object="presence"},
    ...
    uce_role:add(Domain, #uce_role{id={"testrole_location", Domain},
                                   acl=[#uce_access{action="testaction", object="testobject", conditions=[{"a", "b"}]}]}),
    uce_role:add(Domain, #uce_role{id={"testrole_without_location", Domain},
    ...
    uce_user:add(Domain, #uce_user{id=ParticipantId,
                                   name=ParticipantUid,
                                   auth="password",
                                   credential="pwd"}),

    uce_user:add_role(Domain, ParticipantId, {"participant", ""}),
    uce_user:add_role(Domain, ParticipantId, {"testrole_location", "testmeeting"}),
    uce_user:add_role(Domain, ParticipantId, {"testrole_without_location", ""}),
    uce_user:add_role(Domain, ParticipantId, {"participant", ""}),

    AnonymousUid = "anonymous.user@af83.com",
    AnonymousId = {AnonymousUid, Domain},
    uce_user:add(Domain, #uce_user{id=AnonymousId,
                                   name=AnonymousUid,
                                   auth="none",
                                   roles=[]}),
    uce_user:add_role(Domain, AnonymousId, {"anonymous", ""}),
