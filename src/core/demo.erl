...
start() ->
    ...
    uce_user:add(Domain,
                 #uce_user{uid="thierry.bomandouki@af83.com",
                           ...
                           credential="pwd",
                           metadata=[]}),
    uce_acl:add(Domain, #uce_acl{uid="thierry.bomandouki@af83.com",
                                 action="add",
                                 object="presence"}),
    ...
    uce_user:add(Domain,
                 #uce_user{uid="victor.goya@af83.com",
                           ...
                           credential="pwd",
                           metadata=[]}),
    uce_acl:add(Domain, #uce_acl{uid="victor.goya@af83.com",
                                 action="add",
                                 object="presence"}),
    ...
    uce_user:add(Domain,
                 #uce_user{uid="louis.ameline@af83.com",
                           ...
                           credential="pwd",
                           metadata=[]}),
    uce_acl:add(Domain, #uce_acl{uid="louis.ameline@af83.com",
                                 action="add",
                                 object="presence"}),
    ...
    uce_user:add(Domain,
                 #uce_user{uid="alexandre.eisenchteter@af83.com",
                           ...
                           credential="pwd",
                           metadata=[]}),
    uce_acl:add(Domain, #uce_acl{uid="alexandre.eisenchteter@af83.com",
                                 action="add",
                                 object="presence"}),
    ...
    uce_user:add(Domain,
                 #uce_user{uid="romain.gauthier@af83.com",
                           ...
                           credential="pwd",
                           metadata=[]}),
    uce_acl:add(Domain, #uce_acl{uid="romain.gauthier@af83.com",
                                 action="add",
                                 object="presence"}),
    ...
    uce_user:add(Domain,
                 #uce_user{uid="participant",
                           ...
                           credential="pwd",
                           metadata=[]}),
    uce_acl:add(Domain, #uce_acl{uid="participant@af83.com",
                                 action="add",
                                 object="presence"}),
